...
function getfollowModalItem(follow) {
    let item = `<div class="subscribe__item" id="subscribeModalItem-${follow.id}">
                    <div class="subscribe__img">
                        <a href="/user/profile?id=${follow.id}" ><img src="/profile_imgs/${follow.profileImgUrl}" onerror="this.src='/images/default_profile.png';" /></a>
                    </div>
...
function getPostModalInfo(postInfoDto) {
    ...
    <div class="subscribe-header">
            <a href="/user/profile?id=${postInfoDto.postUploader.id}"><img class="post-img-profile pic" src="/profile_imgs/${postInfoDto.postUploader.profileImgUrl}" onerror="this.src='/images/default_profile.png'""></a>
